"""
Django settings for sparrow_shop project.
...
SECRET_KEY = 'django-insecure-iahufhk6^(@tb#$zt51+xo_btd&l%)l6(pde=-it3!z%76%&6@'
...
ROOT_URLCONF = 'sparrow_shop.urls'
...
WSGI_APPLICATION = 'sparrow_shop.wsgi.application'
